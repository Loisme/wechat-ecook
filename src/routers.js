...
const routers = [
  { // 根路由
    ...
    children: [ // 内部子路由
      ...
      { // 热门
        path: '/hot',
        name: 'hot',
        component: require('./components/page/hot.vue')
      },
      { // 分类
        path: '/category',
        name: 'category',
  ...
  { // 菜单列表
    ...
    name: 'menuCollection',
    component(resolve) {
      require.ensure(['./components/page/menuCollection.vue'], () => {
        resolve(require('./components/page/menuCollection.vue'));
      });
    }
  },  { // 菜单列表
    path: '/collectionSort',
    name: 'collectionSort',
    component(resolve) {
      require.ensure(['./components/page/collectionSort.vue'], () => {
        resolve(require('./components/page/collectionSort.vue'));
      });
    }
  },
  { // 菜单列表
  ...
  { // 推荐列表
    ...
    name: 'recommend',
    component(resolve) {
      require.ensure(['./components/page/recommend.vue'], () => {
        resolve(require('./components/page/recommend.vue'));
      });
    }
  }, { // 菜式详情信息
    path: '/menuDetail',
